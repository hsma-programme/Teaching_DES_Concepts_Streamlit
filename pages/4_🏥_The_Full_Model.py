...
tab4, tab2, tab1, tab3 = st.tabs(
    ["Information", "Exercise", "Playground", "Compare Scenario Outputs"]
)
...
with tab1:
    ...
    with col5:
        st.write(
            "Total rooms in use is {}".format(
                n_cubicles_1 + n_cubicles_2 + n_exam + n_trauma + n_triage + n_reg
            )
        )
    with col6:
        with st.expander("Advanced Parameters"):
            ...
            n_reps = st.slider(
                "🔁 How many times should the simulation run? WARNING: Fast/modern computer required to take this above 5 replications.",
                1,
                10,
                step=1,
                value=3,
    ...
    if button_run_pressed:
        ...
        with st.spinner("Simulating the minor injuries unit..."):
            ...
            animation_dfs_log = reshape_for_animations(
                event_log=full_event_log[
                    (full_event_log["rep"] == 1)
                    & (
                        (full_event_log["event_type"] == "queue")
                        | (full_event_log["event_type"] == "resource_use")
                        | (full_event_log["event_type"] == "arrival_departure")
                    )
                ],
        ...
        tab_playground_results_1, tab_playground_results_2, tab_playground_results_3 = (
            st.tabs(["Simple Graphs", "Animated Log", "Advanced Graphs"])
        )
    ...
    """
        ...
        with tab_playground_results_1:
            ...
            with col_res_a:
                ...
                st.plotly_chart(util_fig_simple, use_container_width=True)
            ...
            with col_res_b:
                ...
                st.plotly_chart(wait_fig_simple, use_container_width=True)
        ...
        with tab_playground_results_3:
            ...
            with col_res_1:
                ...
                st.plotly_chart(utilisation_boxplot, use_container_width=True)
            ...
            with col_res_2:
                ...
                st.plotly_chart(wait_boxplot, use_container_width=True)
    ...
    if len(st.session_state["session_results"]) > 0:
        ...
        with scenario_tab_1:
            ...
            with col_x:
                ...
                st.plotly_chart(all_run_util_bar, use_container_width=True)
            ...
            with col_y:
                ...
                st.plotly_chart(all_run_wait_bar, use_container_width=True)
        ...
        with scenario_tab_2:
            ...
            with col_res_1:
                ...
                st.plotly_chart(all_run_util_box, use_container_width=True)
            ...
            with col_res_2:
                ...
                # Add in a box plot showing waits
                st.plotly_chart(all_run_wait_box, use_container_width=True)
            ...
            with col_res_3:
                ...
                # Add in a box plot showing waits
                st.plotly_chart(all_results_throughput_box, use_container_width=True)
